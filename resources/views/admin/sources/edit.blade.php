...
@section('content')
    ...
    <div class="m-portlet">
        ...
        <!--begin::Form-->
        <form class="m-form m-form--fit m-form--label-align-right" action="{{route('admin.sources.edit', $source->id)}}" method="post" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="m-portlet__body">
                <div class="form-group m-form__group row @error('name') has-danger @enderror">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-12">
                        <input type="text" class="form-control m-input" name="name" value="{{ old('name', $source->name) }}" placeholder="Name" required="required" autofocus>
                        @error('name')
