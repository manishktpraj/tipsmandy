    ...
    <div id="fdscontainer" class="fdscontainer" style="display: none;">
        ...
        <div class="form-group m-form__group row @error('interest') has-danger @enderror">
            ...
            <div class="col-lg-7 col-md-7 col-sm-12">
                <input type="text" class="form-control m-input" name="interest" value="{{ old('interest') }}" placeholder="Interest" onkeypress="return NumericValidation(event);">
                @error('interest')
        ...
        <div class="form-group m-form__group row @error('start_year') has-danger @enderror">
            ...
            <div class="col-lg-3 col-md-3 col-sm-12">
                <input type="text" class="form-control m-input" name="start_year" value="{{ old('start_year') }}" placeholder="Minimum Days" onkeypress="return NumericValidation(event);">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <input type="text" class="form-control m-input" name="end_year" value="{{ old('end_year') }}" placeholder="Maximum Days" onkeypress="return NumericValidation(event);">
