    ...
    @endpush
	<div id="mfwrapper" style="display:none;">
        ...
        <div class="form-group m-form__group row @error('caps_type') has-danger @enderror">
            ...
            <div class="col-lg-7 col-md-7 col-sm-12">
                <select class="form-control" name="caps_type" id="caps_type">
                    ...
                    <option value="{{$mfFundTypesValue}}">{{$mfFundTypesValue}}</option>
                    @endforeach
                </select>
                @error('caps_type')
        ...
        <div class="form-group m-form__group row @error('purpose') has-danger @enderror">
            ...
            <div class="col-lg-7 col-md-7 col-sm-12">
                <select class="form-control" name="purpose" id="purpose">
                    ...
                    <option value="{{$mfPurposeValue}}">{{$mfPurposeValue}}</option>
                    @endforeach
                </select>
                @error('purpose')
                <div class="form-control-feedback">{{ $message }}</div>
        ...
        <div class="form-group m-form__group row">
			...
			<div class="col-lg-5 col-md-5 col-sm-12">
				<input type="text" class="form-control m-input scheme_name" id="scheme_name" name="mf_stock_name" placeholder="Scheme Name">
			</div>
		</div>
        ...
        <div class="form-group m-form__group row">
            ...
            <div class="col-lg-5 col-md-5 col-sm-12">
                <input type="text" class="form-control m-input scheme_code" id="scheme_code" name="scheme_code" placeholder="Scheme Code">
            </div>
        </div>
        ...
        <div class="form-group m-form__group row">
            ...
            <div class="col-lg-5 col-md-5 col-sm-12">
                <input type="text" class="form-control m-input isin_div_payout_isin_growth" id="isin_div_payout_isin_growth" name="isin_div_payout_isin_growth" placeholder="ISIN Div Payout/ISIN Growth">
            </div>
        </div>
        ...
        <div class="form-group m-form__group row">
            ...
            <div class="col-lg-5 col-md-5 col-sm-12">
                <input type="text" class="form-control m-input isin_div_reinvestment" id="isin_div_reinvestment" name="isin_div_reinvestment" placeholder="ISIN Div Reinvestment">
            </div>
        </div>
        ...
        <div class="form-group m-form__group row">
            <label class="col-form-label col-lg-3 col-sm-12">Scheme Name *</label>
            <div class="col-lg-5 col-md-5 col-sm-12">
                <input type="text" class="form-control m-input mutual_scheme_name" id="mutual_scheme_name" name="mutual_scheme_name" placeholder="Scheme Name">
            </div>
        </div>
        ...
        <div class="form-group m-form__group row">
            ...
            <div class="col-lg-5 col-md-5 col-sm-12">
                <input type="text" class="form-control m-input net_asset_value" id="net_asset_value" name="net_asset_value" placeholder="Net Asset Value">
            </div>
        </div>
        ...
        <div class="form-group m-form__group row">
            ...
            <div class="col-lg-5 col-md-5 col-sm-12">
                <input type="text" class="form-control m-input date" id="date" name="date" placeholder="Date">
            </div>
        </div>
        ...
        <div class="form-group m-form__group row">
            ...
            <div class="col-lg-5 col-md-5 col-sm-12">
                <input type="text" class="form-control m-input scheme_type" id="scheme_type" name="scheme_type" placeholder="Scheme Type">
            </div>
        </div>
        ...
        <div class="form-group m-form__group row">
            ...
            <div class="col-lg-5 col-md-5 col-sm-12">
                <input type="text" class="form-control m-input scheme_category" id="scheme_category" name="scheme_category" placeholder="Scheme Category">
            </div>
        </div>
        ...
        <div class="form-group m-form__group row">
            ...
            <div class="col-lg-5 col-md-5 col-sm-12">
                <input type="text" class="form-control m-input mutual_fund_family" id="mutual_fund_family" name="mutual_fund_family" placeholder="Mutual Fund Family">
            </div>
        </div>
        ...
        <div class="form-group m-form__group row">
            ...
            <div class="col-lg-5 col-md-5 col-sm-12">
                <textarea class="form-control mf_api" name="mf_api" id="mf_api" rows="50"></textarea>
            </div>
        </div>
        ...
        <div class="form-group m-form__group row @error('mf_rating') has-danger @enderror">
            ...
            <div class="col-lg-7 col-md-7 col-sm-12">
                <select class="form-control" name="mf_rating" id="mf_rating">
                    ...
                    <option value="{{$mfRating}}">{{$mfRating}}</option>
                    @endforeach
                </select>
                @error('mf_rating')
                <div class="form-control-feedback">{{ $message }}</div>
