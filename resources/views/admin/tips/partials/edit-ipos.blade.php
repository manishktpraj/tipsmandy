    ...
    <div id="iposcontainer" class="iposcontainer" style="display: {{ $tip->segment == 'IPOs' ? '' : 'none' }};">
        ...
        <div class="form-group m-form__group row @error('price_range') has-danger @enderror">
            ...
            <div class="col-lg-7 col-md-7 col-sm-12">
                <input type="text" class="form-control m-input" name="price_range" value="{{ old('price_range', $tip->ipo_price_range ?? '') }}" placeholder="Price Range">
                @error('price_range')
        ...
        <div class="form-group m-form__group row @error('ipo_open_date') has-danger @enderror">
            ...
            <div class="col-lg-3 col-md-3 col-sm-12">
                <input type="date" class="form-control m-input" name="ipo_open_date" value="{{ old('ipo_open_date', $tip->ipo_open_date ?? '') }}" >
                @error('ipo_open_date')
                <div class="form-control-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <input type="date" class="form-control m-input" name="ipo_close_date" value="{{ old('ipo_close_date', $tip->ipo_close_date ?? '') }}">
        ...
        <div class="form-group m-form__group row @error('ipo_buy_range') has-danger @enderror">
            ...
            <div class="col-lg-7 col-md-7 col-sm-12">
                <input type="text" class="form-control m-input" name="ipo_buy_range" value="{{ old('ipo_buy_range', $tip->ipo_buy_range ?? '') }}" placeholder="Percentage" onkeypress="return NumericValidation(event);">
                @error('ipo_buy_range')
                <div class="form-control-feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="form-group m-form__group row @error('ipo_avoid_range') has-danger @enderror">
            ...
            <div class="col-lg-7 col-md-7 col-sm-12">
                <input type="text" class="form-control m-input" name="ipo_avoid_range" value="{{ old('ipo_avoid_range', $tip->ipo_avoid_range ?? '') }}" placeholder="Percentage" onkeypress="return NumericValidation(event);">
        ...
        <div class="form-group m-form__group row @error('ipo_rating') has-danger @enderror">
            ...
            <div class="col-lg-7 col-md-7 col-sm-12">
                <select class="form-control" name="ipo_rating" id="ipo_rating">
                    ...
                    <option {{ old('ipo_rating', $tip->rating ?? '') == $ncdRating ? 'selected' : '' }} value="{{$ncdRating}}">{{$ncdRating}}</option>
                    @endforeach
                </select>
                @error('ipo_rating')
                <div class="form-control-feedback">{{ $message }}</div>
