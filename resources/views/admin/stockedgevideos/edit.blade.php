...
@section('content')
    ...
    <div class="m-portlet">
        ...
        <!--begin::Form-->
        <form class="m-form m-form--fit m-form--label-align-right" action="{{route('admin.stockedgevideos.edit', $video->id)}}" method="post" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="m-portlet__body">
				...
				<div class="form-group m-form__group @error('title') has-danger @enderror">
                    ...
                    <input type="text" class="form-control m-input" name="title" value="{{ old('title', $video->title) }}" placeholder="Title" required="required">
                    @error('title')
                ...
                <div class="form-group m-form__group @error('video_url') has-danger @enderror">
                    ...
                    <input type="url" class="form-control m-input" name="video_url" value="{{ old('video_url', $video->youtube_url) }}" placeholder="Video Url" required="required">
                    @error('video_url')
                    <div class="form-control-feedback">{{ $message }}</div>
                    @enderror
                </div>
