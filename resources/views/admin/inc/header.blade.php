                            ...
                            <div class="m-stack m-stack--ver m-stack--general">
                                <div class="m-stack__item m-stack__item--middle m-brand__logo">
                                    <a href="{{route('admin.dashboard')}}" class="m-brand__logo-wrapper">
                                        <img alt="" src="{{asset('public/assets/logo/logo.png')}}" width="65%" />
                                        {{--Stock Tips--}}
                                    </a>
                                </div>
                                         ...
                                         m-dropdown-toggle="click">
                                            <a href="#" class="m-nav__link m-dropdown__toggle">
                                                <span class="m-topbar__userpic">
                                                    <img src="{{Profile::admin_avatar(Auth::guard('admin')->user()->id)}}" class="m--img-rounded m--marginless" alt="" />
                                                </span>
                                            ...
                                            <div class="m-dropdown__wrapper">
                                                ...
                                                <div class="m-dropdown__inner">
                                                    <div class="m-dropdown__header m--align-center" style="background: url({{asset('public/assets/app/media/img/misc/user_profile_bg.jpg')}}); background-size: cover;">
