...
@section('content')
    ...
    <div class="m-portlet">
        ...
        <!--begin::Form-->
        <form class="m-form m-form--fit m-form--label-align-right" action="{{route('admin.pages.edit', $page->id)}}" method="post" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="m-portlet__body">
				...
				<div class="form-group m-form__group @error('name') has-danger @enderror">
                    ...
                    <input type="text" class="form-control m-input" name="name" value="{{ old('name', $page->name ?? '') }}" placeholder="Name" required="required" autofocus>
					@error('name')
